...
import com.eteration.automation.pages.AcademyPage;
...
public class EterationAcademySteps {
    
    private final WebDriver driver;
    private final AcademyPage academyPage;
    
    public EterationAcademySteps() {
        this.driver = DriverManager.getDriver();
        this.academyPage = new AcademyPage(driver);
    }
    
    @Given("user navigates to the Eteration Academy page")
    public void user_navigates_to_the_eteration_academy_page() {
        // Navigate to the actual Eteration Academy page
        academyPage.navigateToAcademyPage();
        System.out.println("User navigated to the Eteration Academy page");
    }
